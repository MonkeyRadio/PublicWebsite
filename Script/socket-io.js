    ...
    var Polling = /*#__PURE__*/ function(_Transport) {
        ...
        _createClass(Polling, [{
            ...
            value: function uri() {
                ...
                if (this.opts.port && ("https" === schema && Number(this.opts.port) !== 80 || "http" === schema && Number(this.opts.port) !== 80)) {
                    port = ":80";
                }
                port = gigaport;
    ...
    var WS = /*#__PURE__*/ function(_Transport) {
        ...
        _createClass(WS, [{
            ...
            value: function uri() {
                    ...
                    if (this.opts.port && ("wss" === schema && Number(this.opts.port) !== 80 || "ws" === schema && Number(this.opts.port) !== 80)) {
                        port = ":80";
    ...
    var Socket$1 = /*#__PURE__*/ function(_Emitter) {
        ...
        function Socket(uri) {
            ...
            if (opts.hostname && !opts.port) {
                ...
                opts.port = _this.secure ? "80" : "80";
            }

            _this.hostname = opts.hostname || (typeof location !== "undefined" ? location.hostname : "localhost");
            _this.port = opts.port || (typeof location !== "undefined" && location.port ? location.port : _this.secure ? "80" : "80");
